export default function Sidebar(){
    ...
    const colours = ['marker:text-red-500',
    ...
    return (
        <div className="pt-[31px] w-[250px] max-xl:hidden">
            <div className="flex flex-col gap-[25px] pl-[22px]">
                <div className="flex gap-[14px]">
                    ...
                    <p className="text-[#787486]">Home</p>
                </div>
                <div className="flex gap-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <p className="text-[#787486]">Messages</p>
                </div>
                <div className="flex gap-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <p className="text-[#787486]">Tasks</p>
                </div>
                <div className="flex gap-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <p className="text-[#787486]">Members</p>
                </div>
                <div className="flex gap-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <p className="text-[#787486]">Settings</p>
                </div>
            </div>
            <hr className="w-[224px] ml-[13px] mt-[31px] mb-[31px] text-[#DBDBDB]"/>
            <div className="">
                <div className="pl-[22px] flex gap-[100px] mb-[35px]">
                    <p className="uppercase text-xs text-[#787486] font-semibold">My Projects</p>
                ...
                <div className="pl-[40px]">
                    <ul className="flex flex-col gap-[30px] list-disc">
                        {projects.map((project, index) => (
                            <li key={index} className={`${colours[Math.floor(Math.random() * colours.length)]}`}>{project}</li>
                        ))}
                    </ul>
                </div>
            </div>
            <div className="flex flex-col items-center mt-[76px] relative">
                <div className="bg-[#F5F5F5] rounded-full w-14 h-14 flex justify-center items-center absolute -top-7">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className=" shadow-amber-300 shadow-2xl">
                ...
                <div className="flex flex-col justify-center items-center bg-[#F5F5F5] w-[206px] h-[200px] rounded-2xl">
                    <p className="text-sm mb-[12px]">Thoughts Time</p>
                    <p className="text-xs w-[168px] mb-[14px]">We don&apos;t have any notice for you, till then you can share your thoughts with your peers.</p>
                    <input placeholder="Write a message" className="h-[40px] w-[166px] text-center bg-white"/>
                </div>
            </div>
        </div>
    )
